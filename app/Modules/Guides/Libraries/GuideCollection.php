...
namespace App\Modules\Guides\Libraries;

use App\Modules\Guides\Exceptions\GuideException;
...
class GuideCollection
{
    ...
    public function tableOfContents(): string
    {
        ...
        return view('\App\Modules\Guides\Views\_toc', [
            'pages' => $pages,
            'alias' => $this->alias,
        ]);
    }
    ...
    public function pageLinks()
    {
        ...
        return view('\App\Modules\Guides\Views\_page_links', [
