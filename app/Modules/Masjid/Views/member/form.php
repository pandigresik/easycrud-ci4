...
<?php $this->section('main'); ?>
    <x-page-head>
        <a href="<?php echo $backUrl ?>" class="back">&larr; member</a>
        <h4><?php echo isset($data) ? '<i class="fa fa-pencil"></i>' : '<i class="fa fa-plus"></i>' ?>  member</h4>
    </x-page-head>

    <?php if (isset($data) && null !== $data->deleted_at) { ?>
        <div class="alert danger">
            This member was deleted on <?php echo $data->deleted_at->humanize(); ?>.
            ...
            <fieldset>                                             
                ...
                <div class="row mb-3">                            
                    ...
                    <div class="col-sm-10">
                        ...
                        <p class="text-danger"><?php echo error('wilayah_id'); ?></p>
                        <?php } ?>
                    </div>
                </div>
                <div class="row mb-3">                            
