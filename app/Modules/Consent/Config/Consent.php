...
namespace App\Modules\Consent\Config;
...
class Consent extends BaseConfig
{
     ...
     * build system, etc.
     */
    public string $consentForm = 'App\Modules\Consent\Views\consent_form';

    public string $consentFormStyles  = 'App\Modules\Consent\Views\consent_styles';
    public string $consentFormScripts = 'App\Modules\Consent\Views\consent_scripts';
